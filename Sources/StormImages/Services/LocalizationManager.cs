    ...
    public class LocalizationManager : INotifyPropertyChanged
    {
        ...
        private readonly Dictionary<string, Dictionary<string, string>> _translations = new()
        {
            ["ru"] = new Dictionary<string, string>
            {
                ...
                ["PromptTitle"] = "Текстовый промпт",
                ["PromptPlaceholder"] = "Опишите желаемое изображение подробно...",
                ["NegativePromptTitle"] = "Негативный промпт",
                ...
                ["TgChatIdLabel"] = "ID Чата или канала (@username или ID):",
                ...
                ["ThemeMidnight"] = "STORM MIDNIGHT",
                ["ThemeMidnightDesc"] = "Аметистовая ночь",
                ["ThemeDark"] = "STORM DARK",
                ["ThemeDarkDesc"] = "Тёмный кибер",
                ["ThemeNight"] = "STORM NIGHT",
                ["ThemeNightDesc"] = "Чёрный OLED",
                ["ThemeDay"] = "STORM DAY",
                ["ThemeDayDesc"] = "Светлая тема",
                ["ThemeMatrix"] = "STORM MATRIX",
                ["ThemeMatrixDesc"] = "Матричный зелёный",
                ["ThemeCyberpunk"] = "STORM CYBERPUNK",
                ["ThemeCyberpunkDesc"] = "Неон Найт-Сити",
                ["ThemeFantasy"] = "STORM FANTASY",
                ["ThemeFantasyDesc"] = "Королевское золото",
                ["ThemeWarhammer"] = "STORM WARHAMMER 40K",
                ["ThemeWarhammerDesc"] = "Имперская готика",
            ...
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["ThemeMidnight"] = "STORM MIDNIGHT",
                ["ThemeMidnightDesc"] = "Amethyst night",
                ["ThemeDark"] = "STORM DARK",
                ["ThemeDarkDesc"] = "Cyber dark",
                ["ThemeNight"] = "STORM NIGHT",
                ["ThemeNightDesc"] = "Pure OLED black",
                ["ThemeDay"] = "STORM DAY",
                ["ThemeDayDesc"] = "Light theme",
                ["ThemeMatrix"] = "STORM MATRIX",
                ["ThemeMatrixDesc"] = "Matrix emerald",
                ["ThemeCyberpunk"] = "STORM CYBERPUNK",
                ["ThemeCyberpunkDesc"] = "Night City neon",
                ["ThemeFantasy"] = "STORM FANTASY",
                ["ThemeFantasyDesc"] = "Royal gold",
                ["ThemeWarhammer"] = "STORM WARHAMMER 40K",
                ["ThemeWarhammerDesc"] = "Imperial gothic",
            ...
            ["de"] = new Dictionary<string, string>
            {
                ...
                ["LanguageSectionTitle"] = "Oberflächensprache",
                ["LangRu"] = "Russisch",
                ["LangEn"] = "Englisch",
                ["LangDe"] = "Deutsch",
                ["LangFr"] = "Französisch",
            ...
            ["ja"] = new Dictionary<string, string>
            {
                ...
                ["NavSettings"] = "設定",
                ["LanguageSectionTitle"] = "インターフェース言語",
                ["LangRu"] = "ロシア語",
                ["LangEn"] = "英語",
                ["LangDe"] = "ドイツ語",
                ["LangFr"] = "フランス語",
